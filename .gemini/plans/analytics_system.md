...
- [x] Schritt 3: Integration in `run_audit.cjs`. Inkrementierung des Zählers bei KI-Audits implementieren.
- [x] Schritt 4: Abschlussbericht. Anzeige der Statistik am Ende des Audit-Prozesses in `run_audit.cjs`.
- [x] Schritt 5: Validierung. Testlauf des Audits und Überprüfung der `stats.json`.
